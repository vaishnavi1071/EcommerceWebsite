...
public class User {
   ...
   private int userId;
    @Column(length = 26,name="user_name")
   ...
   private String userType;
    ...
    public User(int userId, String userName, String userEmail, String userPassword, String userPhone, String userPic, String userAddress,String usertType) {
        this.userId = userId;
